...
# --- Tabs ---
tabs = ["AI Diagnosis", "Symptoms Guide", "Quiz", "Generate Report"]
...
# -------------------- Quiz Tab --------------------
    ...
    questions = [
        {"q": "What part of the eye does diabetic retinopathy primarily affect?", "opts": ["Cornea", "Lens", "Retina", "Optic nerve"], "ans": 2, "exp": "Correct! DR affects retina vessels."},
        {"q": "Which is a common early symptom?", "opts": ["Sudden blindness", "Floaters or spots", "Eye pain", "Double vision"], "ans": 1, "exp": "Floaters are early signs due to micro-bleeds."},
        {"q": "Which increases the likelihood of DR?", "opts": ["Short duration of diabetes", "Poor blood sugar control", "Low blood pressure", "Low cholesterol"], "ans": 1, "exp": "High blood sugar damages retinal vessels."},
        {"q": "How often should diabetics get eye exams?", "opts": ["Every 5 years", "Only if vision declines", "Annually", "Never if no symptoms"], "ans": 2, "exp": "Annual exams catch DR early."},
        ...
        {"q": "Lifestyle change to reduce risk?", "opts": ["Smoking more", "Exercising regularly", "Avoiding eye exams", "Increasing sugar intake"], "ans": 1, "exp": "Exercise helps control blood sugar."},
        ...
        {"q": "NOT recommended to manage DR risk?", "opts": ["Regular eye exams", "Manage blood pressure", "Quit smoking", "Skip sugar monitoring"], "ans": 3, "exp": "Monitoring sugar is essential."},
    ]
